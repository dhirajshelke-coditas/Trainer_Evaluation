...
public class SpaReservation extends Reservation {
    ...
    public SpaReservation(String reservationId, String guestId, LocalDate reservationDate, String treatmentType, int durationMinutes) {
    ...
    public double getTotalCost() { 
        return RATE_PER_MINUTE * durationMinutes; 
    }
