...
public class EventHallReservation extends Reservation {
    ...
    public EventHallReservation(String reservationId, String guestId,
                                LocalDate reservationDate, String hallName,
                                int numberOfHours) {
    ...
    @Override
    public String getReservationType() { return "EventHallReservation"; }

    @Override
    public double getTotalCost() { return HOURLY_RATE * numberOfHours; }
}